"""
Django settings for onlineDebatePlatform project.
...
def get_local_ip():
    ...
    Returns:
        str: Local IP address or fallback IP if detection fails
    """
    try:
...
ROOT_URLCONF = "onlineDebatePlatform.urls"
...
WSGI_APPLICATION = "onlineDebatePlatform.wsgi.application"
ASGI_APPLICATION = "onlineDebatePlatform.asgi.application"
...
if "test" in sys.argv or "pytest" in sys.modules:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": os.getenv("DB_NAME", "onlinedebateplatform"),
...
# Use Redis for production, LocMem for development
try:
    import redis
...
except (ImportError, redis.ConnectionError, redis.TimeoutError, NameError):
